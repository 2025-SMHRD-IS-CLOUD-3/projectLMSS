...
<body>
    ...
    <main class="paper" role="main">
        <h1>랜드마크란?</h1>
        <div class="blk">
            <p>랜드마크는 특정 지역을 대표하거나 식별할 수 있는 지형지물이나 구조물로, 역사적·문화적·건축학적·상징적인 의미를 지닙니다.</p>
            <p>역사적으로는 탐험가나 여행자가 경로를 기억하기 위해 사용했으며, 현대에는 건물, 조각상, 문화재, 지형 등 다양한 형태로 지역을 상징하며 관광과 경제에 영향을 줍니다.</p>
        </div>
        ...
        <section class="section">
            ...
            <div class="blk">
                ...
                <p>➊ <b>이미지 분석</b>: YOLOv8 기반 딥러닝 모델로 사진을 분석해 랜드마크를 정확히 식별합니다.</p>
                <p>➋ <b>정보 제공</b>: 이름, 역사, 건축 양식, 다각도 이미지, 지도 위치 등 풍부한 정보를 제공합니다.</p>
                <p>➌ <b>기반 탐색</b>: 지도에서 랜드마크 위치와 함께 주변 맛집, 포토 스팟, 명소 정보를 시각적으로 탐색할 수 있습니다.</p>
                <p>➍ <b>커뮤니티</b>: 게시판과 댓글 기능으로 여행 정보를 공유하고 소통할 수 있습니다.</p>
                <p>➎ <b>개인화 서비스</b>: 회원가입/로그인 후 즐겨찾기, 내가 쓴 글과 댓글을 관리할 수 있는 마이페이지 기능을 제공합니다.</p>
                <p>➏ <b>핫스팟 제안 기능</b>: 사용자는 랜드마크 주변의 '포토 스팟','주변 명소','주변 맛집'을 제안하고 운영자가 수락 시에 지도에 반영합니다.</p>
            </div>
            <div class="blk">
